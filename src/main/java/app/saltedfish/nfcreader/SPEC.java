...
public final class SPEC {
	...
	public enum APP {
		...
		AEDEBIT(R.string.spec_app_aedebit),
		AECREDIT(R.string.spec_app_aecredit),
		AECNDEBIT(R.string.spec_app_aecndebit),
		AECNCREDIT(R.string.spec_app_aecncredit),
		AEUNKNOWN(R.string.spec_app_aeunknown),
		VISAUNKNOWN(R.string.spec_app_visaunknown),
